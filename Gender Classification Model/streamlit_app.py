...
@st.cache_resource
def load_encoder():
    return SentenceTransformer('flax-sentence-embeddings/all_datasets_v4_MiniLM-L6')
...
def run():
    st.markdown("""
        ...
        .stButton>button { background-color: #d81b60; color: white; border-radius: 5px; }
        .stButton>button:hover { background-color: #ad1457; }
        </style>
